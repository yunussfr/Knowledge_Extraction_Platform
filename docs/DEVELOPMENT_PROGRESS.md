...
| 6. Four separated prompts | Complete | `src/agents/prompts/dataset_generation.py` | Research planning, source evaluation, schema design, and structured extraction use independent system prompts. |
